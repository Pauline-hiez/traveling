...
<main class="-mt-20 flex min-h-screen items-center justify-center px-4">
    <div class="bloc-cuir w-full max-w-md p-8">
        ...
        <form method="POST" action="<?= BASE_URL ?>auth/register" class="flex flex-col gap-3">
        ...
        <p class="mt-4 text-sm">Déjà inscrit ? <a href="<?= BASE_URL ?>login" class="opacity-90">Connexion</a></p>
    </div>
</main>