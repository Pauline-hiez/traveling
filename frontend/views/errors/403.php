<?php $page_bg = ASSETS_URL . 'img/bg/gandalf.png'; ?>
...
<main class="-mt-20 flex min-h-screen flex-col items-center justify-center px-4 text-center">
    ...
    <div class="mb-8">
        ...
        <h1 class="m-0 text-8xl font-bold text-[var(--gold)] shadow-[0_4px_20px_rgba(0,0,0,.8)] md:text-9xl">— 403 —</h1>
    </div>
